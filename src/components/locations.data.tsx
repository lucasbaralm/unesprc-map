export type Location = {
  ...
  category: 'mercado' | 'padaria' | 'hortifrutti/mercearia' | 'bar' | 'farmacia' | 'academia' | 'unidadeSaude' | 'entrada' | 'shopping' | 'rodoviaria' | 'restaurante' | 'moradia' | 'bicicletaria';
  address: string;
};
...
export const locations: Location[] = [
  ...
  {
    name: 'Bicicletaria Motocario',
    position: [-22.39791304027432, -47.55538636441842],
    category: 'bicicletaria',
    address: 'Av. 24 A, 427 - Vila Alemã',
  },
  {
    name: 'Bicicletaria Escher',
    position: [-22.39690897639355, -47.5547879729609],
    category: 'bicicletaria',
    address: 'Rua 9 A, 204 - Vila Alemã'
  }
];